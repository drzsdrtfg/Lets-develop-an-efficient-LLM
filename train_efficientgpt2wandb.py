...
Original file is located at
    https://colab.research.google.com/drive/1C577UVfGguRAvON9VOkgH9P8JWokryZC
"""
...
for step in range(max_steps):
    ...
    if step % 250 == 0 or last_step:
        ...
        if master_process:
            ...
            if step > 0 and (step % 1000 == 0 or last_step):
                ...
                # Erweiterter Checkpoint mit zusätzlichen Zuständen
                checkpoint = {
                    'model': raw_model.state_dict(),
                    'optimizer': optimizer.state_dict(),  # Zustand des Optimierers
    ...
    if ((step > 0 and step % 250 == 0) or last_step) and False:
        model.eval()
        ...
        for i in range(num_return_sequences):
            ...
            if master_process:
                wandb.log({f"generated_text_{i}": decoded}, step=step)
...
if __name__ == "__main__":
    # You can add any additional setup or argument parsing here
    pass